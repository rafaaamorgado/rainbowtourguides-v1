/*
  Rainbow Tour Guides - MINIMAL Seed Data
  
  This script uses ONLY the columns from the base schema.
  No extra columns from later migrations.
  
  Run this in Supabase SQL Editor.
*/

-- ============================================================================
-- 1. CITIES (base schema)
-- ============================================================================
...
-- ============================================================================
-- 2. USERS (base schema columns only: id, email, role, displayName, avatarUrl)
-- ============================================================================
INSERT INTO users (id, email, role, "displayName", "avatarUrl") VALUES
  -- Guides
  ('a1111111-1111-1111-1111-111111111111', 'miguel@example.com', 'guide', 'Miguel Santos', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop'),
  ('a2222222-2222-2222-2222-222222222222', 'ana@example.com', 'guide', 'Ana Costa', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop'),
  ('a3333333-3333-3333-3333-333333333333', 'carlos@example.com', 'guide', 'Carlos Rivera', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop'),
  ('a4444444-4444-4444-4444-444444444444', 'sofia@example.com', 'guide', 'Sofía Hernández', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop'),
  ('a5555555-5555-5555-5555-555555555555', 'hannah@example.com', 'guide', 'Hannah Müller', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop'),
  ('a6666666-6666-6666-6666-666666666666', 'max@example.com', 'guide', 'Max Schmidt', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=400&fit=crop'),
  ('a7777777-7777-7777-7777-777777777777', 'lucas@example.com', 'guide', 'Lucas Silva', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=400&h=400&fit=crop'),
  ('a8888888-8888-8888-8888-888888888888', 'marina@example.com', 'guide', 'Marina Oliveira', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop'),
  ('a9999999-9999-9999-9999-999999999999', 'chai@example.com', 'guide', 'Chaiwat S.', 'https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=400&h=400&fit=crop'),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'ploy@example.com', 'guide', 'Ploy Tanaka', 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=400&fit=crop'),
  -- Travelers
  ('b1111111-1111-1111-1111-111111111111', 'jordan@example.com', 'traveler', 'Jordan Smith', 'https://i.pravatar.cc/150?img=1'),
  ('b2222222-2222-2222-2222-222222222222', 'casey@example.com', 'traveler', 'Casey Jones', 'https://i.pravatar.cc/150?img=2'),
  ('b3333333-3333-3333-3333-333333333333', 'alex@example.com', 'traveler', 'Alex Chen', 'https://i.pravatar.cc/150?img=3'),
  ('b4444444-4444-4444-4444-444444444444', 'sam@example.com', 'traveler', 'Sam Taylor', 'https://i.pravatar.cc/150?img=4')
ON CONFLICT (id) DO NOTHING;

-- ============================================================================
-- 3. GUIDE PROFILES (base schema columns only)
-- ============================================================================
INSERT INTO guide_profiles (
  uid, handle, "displayName", "avatarUrl", city, "citySlug", country, timezone,
  bio, languages, themes, photos, prices, "maxGroupSize", "ratingAvg", "ratingCount", verified
) VALUES
  ('a1111111-1111-1111-1111-111111111111', 'miguel-lisbon', 'Miguel Santos',
   'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop',
   'Lisbon', 'lisbon', 'Portugal', 'Europe/Lisbon',
   'Born and raised in Lisbon. Let me show you the best queer bars and hidden gems!',
   '["English", "Portuguese", "Spanish"]'::jsonb,
   '["Nightlife", "LGBTQ+ Culture"]'::jsonb,
...
-- Expected: cities=5, users=14, guides=10, travelers=4
